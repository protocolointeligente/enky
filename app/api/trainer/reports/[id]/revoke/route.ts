...
import { getTrainerReportDocument, revokeReport } from "@/modules/reports/report-service";
import {
...
// Treinador revoga o compartilhamento (PUBLISHED → REVOKED): o relatório deixa
// de existir para o atleta, mas continua no histórico do treinador.
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const report = await revokeReport(id, actor);
