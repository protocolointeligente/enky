...
import { CARTEIRA_WRITE_ROLES, transferAthlete } from "@/modules/coach-team/team-service";
import { transferAthleteSchema } from "@/modules/coach-team/team-schemas";
import {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const input = await parseJsonBody(request, transferAthleteSchema);
    const relationship = await transferAthlete(input, {
